 ...
 * thus n//zot recommended for production applications.
 */
 ...
 */
	Configure::write('Security.salt', 'MLYsLWLDCJIVqV5Fpag4FlBPXT4IKBcQ');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '65656990923232367676767634');
